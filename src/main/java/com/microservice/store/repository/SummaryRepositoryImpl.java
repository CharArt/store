...
import com.microservice.store.config.RedisSchema;
...
public class SummaryRepositoryImpl implements SummaryRepository {
    ...
    private Optional<Summary> getSummary(long sensorId, Set<MeasurementType> measurementTypes, Set<SummaryType> summaryTypes, Jedis jedis) {
